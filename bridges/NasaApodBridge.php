...
class NasaApodBridge extends BridgeAbstract
{
    ...
    public function getIcon() {
        return 'https://voyager.jpl.nasa.gov/assets/images/galleries/images-voyager-took/saturn/saturnx.gif';
    }
    ...
    private function parseXmlItem($feedItem) {
        ...
        foreach ($feedItem->children($namespaces['dc'])->creator as $creator) {
            if (!in_array((string)$creator, ['Robert Nemiroff (MTU)', 'Jerry Bonnell (UMCP)'])) {
