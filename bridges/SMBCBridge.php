...
class SMBCBridge extends FeedExpander
{
    ...
    protected function parseItem($feedItem)
    {
        ...
        $item['content'] = "<figure><img src=\"{$comicURL}\"><figcaption><p>{$hovertext}</p></figcaption></figure><figure style=\"max-width:684px;text-align:right\"><img src=\"{$afterURL}\"></figure>{$news}";
